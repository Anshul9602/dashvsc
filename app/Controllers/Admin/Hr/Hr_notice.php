...
class Hr_notice extends BaseController
{
    protected $HrModel;

    public function __construct()
    {
        $this->HrModel = new Hr_noticeModel();
    }
    ...
    public function listAllhr_notice1($segment)
    {
    ...
    //     echo "</pre>";
    //     die();
        return view('admin/hr_notice/hr_list', $data);
    }
    public function listAllHr_form($segment)
    {
        ...
        return view('admin/hr_notice/hr_form', $data);
    }
    public function listAllHr_form_value($id)
    {
        ...
        return view('admin/hr_notice/hr_form1', $data);
    }
    ...
    public function listHr_delete($id)
    {
        ...
        return redirect()->to(base_url('admin/hr_notice/' . session()->get('token')));
    }
    ...
    public function listHr_save()
    {
        ...
        return redirect()->to(base_url('admin/hr_notice/' . $token));
    ...
    public function store_prof_img($input)
    {
        ...
        if ($file->isValid() && !$file->hasMoved()) {
            ...
            $file->move('uploads/hr_notice/', $newName);

            // Save file information to the database
            $filepath = 'uploads/hr_notice/' . $newName; // Relative path for storage
            ...
            $userFolder = FCPATH . 'uploads/hr_notice/' . $user_id . '-img';
            ...
            rename('uploads/hr_notice/' . $newName, $newResumePath); // Move to user's folder
            $res_p = 'uploads/hr_notice/' . $user_id . '-img/' . $newName;
