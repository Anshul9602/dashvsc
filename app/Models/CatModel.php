...
class CatModel extends Model
{
    ...
    //    die();
        ...
        `recovery_status`,`invoice_no`,`invoice_amount`,`bill_date`,`report_submit_date`,`submit_date`,`fee`,`udin`,
        `udin_no`,`udin_trun`,`audit`,`assignment`,`type`,`status`,`created_at`) VALUES (null,'$name','$branch','$completion','$working','$security_deposit','$recovery_status','$invoice_no','$invoice_amount','$bill_date','$report_submit_date','$submit_date','$fee','$udin','$udin_no','$udin_trun','$audit','$assignment','$type','$status','$date1')";
    ...
    public function update1($id, $data): bool
    {
        ...
        branch = '$branch',completion = '$completion',working = '$working',security_deposit = '$security_deposit',recovery_status = '$recovery_status',invoice_no = '$invoice_no',invoice_amount = '$invoice_amount',bill_date = '$bill_date',report_submit_date = '$report_submit_date',submit_date = '$submit_date',
