                        ...
                        <form action="<?php echo base_url('admin/catalog/category_form_save/'. $token); ?>" method="post">
                            <div class="custom-tab-1">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="row pt-2">
                                        <input type="text" class="d-none" name="id" value="<?= $cat->id ?>">
                                            <div class="col-md-4 mt-3">
                                                <input type="text" class="form-control" name="name"value="<?= $cat->name ?>" placeholder="Organizaion name">
                                            </div>
                                            <div class="col-md-4 mt-3">
                                            ...
                                            <div class="col-md-4 mt-3">
                                                <input type="text" class="form-control" name="audit" value="<?= $cat->audit ?>"placeholder="Frequency Of Audit">
                                            </div>
                                            <div class="col-md-4 mt-3">
                                                <input type="text" class="form-control" name="fee" value="<?= $cat->fee ?>"placeholder="Professinal Fees">
                                            </div>
                                            <div class="col-md-4 mt-3">
                                                <input type="text" class="form-control" name="submit_date" value="<?= $cat->submit_date ?>"placeholder="Last Date of Submission">
                                            </div>
                                            <div class="col-md-4 mt-3">
                                                <input type="text" class="form-control" name="report_submit_date" value="<?= $cat->report_submit_date ?>"placeholder="Report Date of Submission">
                                            </div>
                                            <div class="col-md-4 mt-3">
