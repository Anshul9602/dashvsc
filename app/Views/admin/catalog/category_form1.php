                                    ...
                                    <div class="tab-pane fade show active" id="home1" role="tabpanel">
                                        <div class="row pt-2">
                                            ...
                                            <div class="col-md-4 mt-3">
                                                ...
                                                <select name="branch" id="role" class="form-control" required>
                                                    <?php if ($roles !== null && !empty($roles)): ?>
                                                        <?php foreach ($roles as $index => $user): ?><option
                                            ...
                                            <div class="col-md-4 mt-3">
                                                ...
                                                <select class="form-control form-control-lg" name="audit" id="auditFrequency" required>
                                            ...
                                            <div id="auditDatesContainer" class="col-md-12 row m-0">
                                                <div class="col-md-4 mt-3 pl-0">
                                                    <label for="">
                                                        Professinal Fees</label>
                                                    <input type="text" class="form-control" name="fee" placeholder="Professinal Fees">
                                                </div>
                                                <div class="col-md-4 mt-3">
                                                    <label for="submit_date">Last Date of Submission
                                                    </label>
                                                    <input type="date" class="form-control" name="submit_date[]">
                                                </div>
                                                <div class="col-md-4 mt-3">
                                                    <label for="report_submit_date">Report Date of Submission
                                                    </label>
    ...
    $(document).ready(function() {
        $("#auditFrequency").change(function() {
            ...
            for (let i = 1; i <= count; i++) {
                ...
                container.append(dateFields2);

            }
            for (let i = 1; i <= count; i++) {

                let dateFields3 = `<div class="col-md-4 mt-3 pl-0">
                ...
                container.append(dateFields3);

            }
            for (let i = 1; i <= count; i++) {

                let dateFields4 = ` <div class="col-md-4 mt-3 pl-0">
                                                    <label for="">Completion Certificate Received ${i}</label>
                                                    <input type="text" class="form-control" name="completion[]" placeholder="Completion Certificate Received">
                                                </div>`;

                container.append(dateFields4);
            }
        });
    });
</script>
<script>
    $(document).ready(function() { // Initially hide the fields
...
<script>
    document.getElementById('save_btn33').addEventListener('click', function() { // Trigger a click on the second button
        document.getElementById('s_btnn5').click();
    });
    // Attach a click event to the first button

    document.addEventListener("DOMContentLoaded", function() { // Remove the 'active' class from the 'des-menu' item
