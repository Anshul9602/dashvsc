               ...
               <div class="card-body">
                  ...
                  <div class="custom-tab-1">
                     ...
                     <div class="tab-content tt">
                        <form action="<?php echo base_url('admin/sheet_form/' . $token); ?>" method="post" enctype="multipart/form-data">
                           <div class="tab-pane fade show active" id="home1" role="tabpanel">
                              <input type="text" name="dis" class="form-control d-none" placeholder="Sheet name">
                              <div class="row pt-2">
                                 <div class="col-sm-4">
                                    <p class="mb-0"> Sheet Name </p>
                                    <input type="text" name="name" class="form-control" placeholder="Sheet name">
                                 </div>
                                 <div class="col-sm-4">
                                    ...
                                    <select id="workSelection" name="sheet_cat" style="width: 100%;">
                                       ...
                                       <option value="tagmanager">Google Tag Manager</option>
                                    </select>
                              ...
                              <div class="row">
                                 <div class="col-sm-4 pt-4">
                                    ...
                                    <select id="workSelection" name="cat[]" multiple style="width: 100%;">
                                       <?php if ($cat !== null && !empty($cat)): ?>
                                          <?php foreach ($cat as $index => $user): ?>
                                 ...
                                 <div class="col-sm-4 pt-4">
                                    ...
                                    <input type="text" name="sheet_url" class="form-control" placeholder="Existing Sheet Url">
                                 </div>
                                 <div class="col-sm-4 pt-4">
                                    <p class="mb-0">Cover Image</p>

                                    <input type="file" name="cover_pic" id="cover_pic" class="form-control" placeholder="Existing Sheet Url">
                                    ...
                                    <tbody>
                                       <?php if (!empty($users)): ?>
                                          <?php foreach ($users as $user1): ?>
                                             ...
                                             $permissions = explode(',', $user1->role_permission);
                                             $sheetPermissions = array_filter($permissions, function ($perm) {
                                                return strpos($perm, 'sheets_') === 0;
                                             });
                                             ?>
                                             <tr>
                                                ...
                                                if ($user1->admin_role == "DATA MINER") { ?>
                                                   <td>
                                                      <input class="form-check-input" type="checkbox" name="selected_users[<?php echo $user1->admin_id; ?>]" value="1" id="selectUser-<?php echo $user1->admin_id; ?>" checked>
                                                      <strong><?php echo htmlspecialchars($user1->admin_name); ?></strong>
                                                      <input type="hidden" name="permissions[<?php echo $user1->admin_id; ?>][user_name]" value="<?php echo htmlspecialchars($user1->admin_name); ?>">
                                                   </td>
                                                   <td>
                                                      <strong><?php echo htmlspecialchars($user1->admin_email); ?></strong>
                                                      <input type="hidden" name="permissions[<?php echo $user1->admin_id; ?>][user_email]" value="<?php echo htmlspecialchars($user1->admin_email); ?>">
                                                   </td>
                                                   <?php foreach (['sheets_view', 'sheets_edit'] as $sheetPermission): ?>
                                                      <td>
                                                         <div class="form-check">
                                                            <input class="form-check-input" type="checkbox" name="permissions[<?php echo $user1->admin_id; ?>][<?php echo $sheetPermission; ?>]" value="1"
                                                               id="flexCheckDefault-<?php echo $user1->admin_id . '-' . $sheetPermission; ?>"
                                                               <?php echo in_array($sheetPermission, $sheetPermissions) ? 'checked' : ''; ?>>
                                                            <label class="form-check-label" for="flexCheckDefault-<?php echo $user1->admin_id . '-' . $sheetPermission; ?>">
                                                               Allow
                                                            </label>
                                                         </div>
                                                      </td>
                                                ...
                                                <?php } else { ?>
                                                   <td>
                                                      <input class="form-check-input" type="checkbox" name="selected_users[<?php echo $user1->admin_id; ?>]" value="1" id="selectUser-<?php echo $user1->admin_id; ?>">
                                                      <strong><?php echo htmlspecialchars($user1->admin_name); ?></strong>
                                                      <input type="hidden" name="permissions[<?php echo $user1->admin_id; ?>][user_name]" value="<?php echo htmlspecialchars($user1->admin_name); ?>">
                                                   </td>
                                                   <td>
