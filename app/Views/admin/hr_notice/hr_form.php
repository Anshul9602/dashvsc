    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form action="<?php echo base_url('admin/hr_notice/hr_form/' . $token); ?>" method="post"enctype="multipart/form-data">
                                    ...
                                    <div class="tab-pane fade show active" id="home1" role="tabpanel">
                                        <div class="row pt-2">
                                            <div class="col-sm-4">
                                                ...
                                                <input type="text" class="form-control" name="name" placeholder="Hr Notice name">
                                            </div>
