                            ...
                            <div class="custom-tab-1">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane fade show active" id="home1" role="tabpanel">
                                        <div class="row pt-2">
                                            <div class="col-sm-4">
                                                <input type="text" class="form-contro d-none l" name="id" value="<?= $user->id ?>">
                                                <input type="text" class="form-control" name="name" value="<?= $user->name ?>" placeholder="Hr Policie name">
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-12 pt-4">
                                                ...
                                                <input type="hidden" name="dis" id="description"value="<?= $user->dis ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="tab-pane fade" id="profile1">
                                            <div class="pt-4">
                                                <div class="row">
                                                    ...
                                                    <div class="col-2">
                                                        <img id="previewImage" src="<?php echo base_url(''); ?><?= $user->profile_pic ?>" alt="Selected Image" class="img-thumbnail">
                                                    </div>
                                                    <div class="col-8">
                                                        <input type="file" name="profile_pic" id="imageInput" class="form-control" >
                                                        <input type="text" name="profile_pic_h"  class="form-control d-none" value="<?= $user->profile_pic ?>">
                                                    </div>
                                                </div>
