...
<?php if (in_array('hr_policies_edit', $permissionsArray)): ?>
                          <a href="<?php echo base_url('admin/hr/hr_form_value/'. $user->id ); ?>" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a><?php endif; ?><?php 
$permission = session()->get('admin_permission'); 
...
<?php if (in_array('hr_policies_delete', $permissionsArray)): ?>
   ...
   data-url="<?php echo base_url('admin/hr/hr_delete/' . $user->id); ?>">
